  ...
  group('ReactiveCheckboxListTile Tests', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final form = FormGroup.lazy(
          {
            reactiveCheckboxListTileTestingName: FormControl<bool>.lazy(),
          },
        );

        // And: a checkbox is bind to boolean control
        await tester.pumpWidget(
          ReactiveCheckboxListTileTestingWidget(form: form),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        // And: a checkbox is bind to boolean control
        await tester.pumpWidget(
          ReactiveCheckboxListTileTestingWidget(form: form, tristate: true),
        );
    ...
    testWidgets('if FormControl with defaults to True then Checkbox checked', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('Control disabled by default disable Checkbox', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('Disable a control disable Checkbox', (
      WidgetTester tester,
    ) async {
      // Given: a form
      final form = FormGroup.lazy(
    ...
    testWidgets('Enable a control enable Checkbox', (
      WidgetTester tester,
    ) async {
      // Given: a form
      final form = FormGroup.lazy(
    ...
    testWidgets('Provide a FocusNode to ReactiveListTile', (
      ...
      // And: a widget that is bind to the form
      await tester.pumpWidget(
        ReactiveCheckboxListTileTestingWidget(form: form, focusNode: focusNode),
      );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        // Given: A group with a field
        final nameControl = FormControl<bool>.lazy();
        final form = FormGroup.lazy(
          {
    ...
    testWidgets('ReactiveCheckboxListTile onChanged callback is called', (
      WidgetTester tester,
    ) async {
