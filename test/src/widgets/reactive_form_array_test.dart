...
void main() {
  group('ReactiveFormArray Tests', () {
    testWidgets('ReactiveFormArray display same amount of items of the array', (
      WidgetTester tester,
    ) async {
      // Given: a form with array
      final form = FormGroup.lazy(
        {
          'array': FormArray<Object>.lazy(
            [
              FormControl.lazy(),
              FormControl.lazy(),
              FormControl.lazy(),
    ...
    testWidgets('ReactiveFormArray rebuild when added control', (
      WidgetTester tester,
    ) async {
      // Given: a form with array
      final form = FormGroup.lazy(
      ...
      (form.control('array') as FormArray<Object>).add(FormControl.lazy());
      await tester.pump();
    ...
    testWidgets('ReactiveFormArray rebuild when added collection of control', (
      WidgetTester tester,
    ) async {
      // Given: a form with array
      final form = FormGroup.lazy(
    ...
    testWidgets('ReactiveFormArray rebuild when remove control', (
      WidgetTester tester,
    ) async {
      // Given: a form with array
      final form = FormGroup.lazy(
    ...
    testWidgets('Assert error if formArrayName and formArray is null', (
      WidgetTester tester,
    ) async {
      expect(
        () =>
            ReactiveFormArray(builder: (context, array, child) => Container()),
        throwsAssertionError,
      );
    });

    testWidgets('Assert error if formArrayName and formArray not null', (
      WidgetTester tester,
    ) async {
      expect(
