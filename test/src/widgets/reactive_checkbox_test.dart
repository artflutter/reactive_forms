...
void main() {
  group('ReactiveCheckbox Tests', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final form = FormGroup.lazy(
          {
            reactiveCheckboxTestingName: FormControl<bool>.lazy(),
          },
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          ReactiveCheckboxTestingWidget(form: form, tristate: true),
        );
    ...
    testWidgets('Provide a FocusNode to ReactiveCheckbox', (
      WidgetTester tester,
    ) async {
      // Given: A group with a field
      final form = FormGroup(
      ...
      // And: a widget that is bind to the form
      await tester.pumpWidget(
        ReactiveCheckboxTestingWidget(form: form, focusNode: focusNode),
      );
    ...
    testWidgets('ReactiveCheckbox onChanged callback is called', (
      WidgetTester tester,
    ) async {
